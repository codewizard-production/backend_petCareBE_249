package com.app.petCareBE.model;
...
import com.app.petCareBE.converter.DurationConverter;
import com.app.petCareBE.converter.UUIDToByteConverter;
import com.app.petCareBE.converter.UUIDToStringConverter;
...
@Table(name = "\"PetCareCenter\"", schema =  "\"petcarebe\"")
@Data
...
@Column(name = "\"BusinessHours\"")
    ...
    @CollectionTable(schema = "\"petcarebe\"", name = "\"PetCareCenterBusinessHours\"",joinColumns = @JoinColumn(name = "\"PcId\""))
...
@JoinTable(
            ...
            inverseJoinColumns = @JoinColumn( name="\"DocId\""), schema = "\"petcarebe\"")
...
@JoinTable(
            ...
            joinColumns = @JoinColumn( name="\"PcId\""),
            inverseJoinColumns = @JoinColumn( name="\"ServiceId\""), schema = "\"petcarebe\"")
...
@JoinTable(
            ...
            joinColumns = @JoinColumn( name="\"PcId\""),
            inverseJoinColumns = @JoinColumn( name="\"PetId\""), schema = "\"petcarebe\"")
